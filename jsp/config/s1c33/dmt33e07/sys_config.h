 ...
 *  起動メッセージのターゲット名
 */
#define TARGET_NAME	"EPSON S1C33 PE processor"
...
get_Offset(INTNO intno)
{
	...
	switch(intno)
	{
		...
		case S1C33_INHNO_ADOUTRANGE:		/* A/DConv, clocktimer, */
		case S1C33_INHNO_AD:			/* Port 4-7 group	*/
		...
		case S1C33_INHNO_LCDC:			/* LCD controller */
			iOffset = 8;
			break;

		case S1C33_INHNO_SERIAL2ERR:		/* Serial I/O Ch.2,	*/
		case S1C33_INHNO_SERIAL2RX:		/* SPI group		*/
		case S1C33_INHNO_SERIAL2TX:
		case S1C33_INHNO_SPIRX:
		case S1C33_INHNO_SPITX:
			iOffset = 9;
			break;

		case S1C33_INHNO_PINT8:			/* Port 8-15 group */
		case S1C33_INHNO_PINT9:
		case S1C33_INHNO_PINT10:
		case S1C33_INHNO_PINT11:
		case S1C33_INHNO_PINT12:
		case S1C33_INHNO_PINT13:
		case S1C33_INHNO_PINT14:
		case S1C33_INHNO_PINT15:
			iOffset = 54;
			break;

		case S1C33_INHNO_I2S:			/* I2S interruption group */
			iOffset = 55;			
			break;
...
get_BitFlag(INTNO intno)
{
	...
	switch(intno)
	{
		...
		case S1C33_INHNO_ADOUTRANGE:
		case S1C33_INHNO_SERIAL2ERR:
		case S1C33_INHNO_PINT8:
			iBitFlag = 0x01;
			break;
		...
		case S1C33_INHNO_SERIAL0RX:
		case S1C33_INHNO_AD:
		case S1C33_INHNO_LCDC:
		case S1C33_INHNO_SERIAL2RX:
		case S1C33_INHNO_PINT9:
			iBitFlag = 0x02;
			break;
