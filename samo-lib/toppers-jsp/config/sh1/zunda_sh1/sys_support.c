...
hardware_init_hook(void)
{
	 ...
	 * WPU=1    WAIT端子プルアップ
	 * A02LW=00 エリア0,2を1杓爵失酌宍蒔軸柴
	 * A6LW=00  エリア6  を1杓爵失酌宍蒔軸柴
	 */
	sil_wrh_mem(BSC_WCR3, 0x8000); 
	
	/* BCR:バスコントロールレジスタ
	 * DRANE=0   雫借竺1は外部メモリ空間
	 * IOE=0     雫借竺6は外部メモリ空間
	 * WARP=0    舎鴫煮勺謝鴫柴酌:外部竺失疾漆と内部竺失疾漆を同時に行わない
	 ...
	 * read cycle stateで
	 * wait端子サンプルしない
	 * RWx=0  エリア1,3,4,5,7 1漆偲鴫柴固定
	 * RWx=0  エリア0,2,6 1漆偲鴫柴+杓爵失酌宍蒔軸柴（計3漆偲鴫柴）
	 * WW1=1  エリア1外部者謝借 2漆偲鴫柴
	 */
