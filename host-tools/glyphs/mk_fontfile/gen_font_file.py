...
def usage():
	...
	print "Usage: %s <fontpath> [<outfilename>] [<fontmapfilename>] [<default>]" % (sys.argv[0])
	...
	print "\t<default> the font to be used as 0. Defaults to '%s'" % (default_font)
	sys.exit(1)
